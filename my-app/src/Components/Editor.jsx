  ...
  return (
    ...
    */}
    ...
    <div className='resContent'>
            ...
            <div>
               <button className=' items-center  mt-10 rounded-lg left-2 border-2 border-black w-36 fixed bottom-2 h-16' onClick={() =>setOpenModal(true)}>
                Click to Buy
               </button>
    ...
    {/* --------------------------------------------------------------------------------------------------------------------------------- */}
       <div className='contentDiv'>
            ...
            <div className='h-auto p-0 mt-10 items-center flex md:p-5 justify-between '>
